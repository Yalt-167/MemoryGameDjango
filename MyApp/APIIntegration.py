...
=======
URL_ = "https://api.memegen.link/images/custom/"
# _ at the end bc don t wanna risk overwriting anything remotely important

def generate_meme(topText: str, bottomText: str):

    #links cant contain spaces so replace them with _
    memeURL = f"{URL_}{topText.replace(" ", "_")}/{bottomText.replace(" ", "_")}.png"
